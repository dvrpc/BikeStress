...
def run_child_moving_frame(i, j, log=False):
    ...
    ####CHANGE FOR EACH SPECIAL DESTINATION####
    ...
    with open(r"D:\BikePedTransit\BikeStress\phase3\phase3_pickles\group1438_MF_%s_%s_transit.cpickle" % (i, j), "wb") as io:
        cPickle.dump(paths, io)
    with open(r"D:\BikePedTransit\BikeStress\phase3\phase3_pickles\group1438_MF_%s_%s_nopaths_transit.cpickle" % (i, j), "wb") as io:
