...
TBL_TEMP_NETWORK = "temp_network_338_%d" % chunk_id
TBL_TEMP_PAIRS = "temp_pairs_338_%d" % chunk_id
...
""".format(TBL_CHUNK_OD_LINES, TBL_TEMP_PAIRS, TBL_GEOFF_GEOM)
...
for i in xrange(1, iterations+1):
    ...
    TBL_TEMP_PAIRS_2 = "temp_pairs_338_%d_%d" % (chunk_id, newid)
    TBL_TEMP_NETWORK_2 = "temp_network_338_%d_%d" % (chunk_id, newid)
