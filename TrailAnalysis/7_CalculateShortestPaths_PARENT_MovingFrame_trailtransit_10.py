#copy to run in cmd
#C:\Users\model-ws\AppData\Local\Continuum\Anaconda2\python.exe D:\BikePedTransit\BikeStress\scripts\GIT\BikeStress\Phase2\TrailAnalysis\7_CalculateShortestPaths_PARENT_MovingFrame_trailtransit_10.py
