#copy to run in cmd
#C:\Users\model-ws\AppData\Local\Continuum\Anaconda2\python.exe D:\BikePedTransit\BikeStress\scripts\GIT\BikeStress\Phase2\speedtest\test1\6_CalculateShortestPaths_PARENT_trailtransit.py
...
script = r"D:\BikePedTransit\BikeStress\scripts\GIT\BikeStress\Phase2\speedtest\test1\6_CalculateShortestPaths_CHILD_trailtransit.py"
cleanup_script = r"D:\BikePedTransit\BikeStress\scripts\GIT\BikeStress\Phase2\speedtest\test1\6_CalculateShortestPaths_CLEANUP.py"
...
a = 6991 #min island number
b = 6991 #max island number
c= b+1
dumpers = []
for i in xrange(a, c):
    cur.execute("SELECT COUNT(*) FROM %s WHERE MIXID > 0" % (TBL_TEMP_NETWORK % i))
